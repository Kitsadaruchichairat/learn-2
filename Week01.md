...
* dir (directory)  :  คือการแสดงไฟล์ทั้งหมดที่อยู่ใน directory ปัจจุบัน
* cd (change directory ) :   คือการเปลี่ยนโฟลเดอร์ 
* mkdir : คำสั่ง mkdir ใช้สร้างโฟลเดอร์ใหม่ พิมพ์ mkdir ตามด้วยชื่อโฟลเดอร์ที่ต้องการ
* rmdir : ถ้าเราต้องการลบโฟลเดอร์เปล่า ให้เราพิมพ์คำสั่ง rmdir ตามด้วยชื่อโฟลเดอร์นั้น
* rmdir ชื่อโฟลเดอร์ /s : ลบโฟลเดอร์ที่มีข้อมูลหรือไฟล์งานต่างๆอยู่ข้างใน
* move : คำสั่ง move ใช้ย้ายไฟล์ไปที่โฟลเดอร์ที่เราต้องการ
* del (delete): ลบไฟล์ออกจากคอมพิวเตอร์เลย  ถ้าชื่อไฟล์มีการเคาะ space ตรงกลาง ให้เราพิมพ์ชื่อไฟล์ใน double quote เช่น del “my data.csv”
...
# Docker คืออะไร![Logo3](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-oV3dKd5Y4KDxi4D-pwdGQYdk44HHZgVStQ&s)
